...
public class BuyResult extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// セッションからカート情報を取得
			ArrayList<ItemDataBeans> cart = (ArrayList<ItemDataBeans>) Ec2Helper.cutSessionAttribute(session, "cart");

			BuyDataBeans bdb = (BuyDataBeans) Ec2Helper.cutSessionAttribute(session, "bdb");
