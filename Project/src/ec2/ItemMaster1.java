...
/**
 * Servlet implementation class ItemMaster1
 */
@WebServlet("/ItemMaster1")
public class ItemMaster1 extends HttpServlet {
		...
		HttpSession session = request.getSession();
           ...
           if(!(userId == 1)) {
			...
			// ItemMaster1のjspにフォワード
	  		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/ItemMaster1.jsp");
