...
<nav class="navbar navbar-dark bg-dark">
  <form class="form-inline mt-2 mt-md-0">
    <h3 class="text-light bg-dark"><strong>購入完了　</strong></h3>
  </form>
  <form class="form-inline mt-2 mt-md-0">
...
<div class="text-center style1">
  <p>
    <a href="#" class="btn btn-primary my-2 center" onClick="location.href='SerchResult'">引き続き買い物をする </a>
    <a href="#" class="btn btn-secondary my-2 center" onClick="location.href='BuyDateHistory'">購入履歴を確認する</a>
 </p>
</div>

<div class="tablestyle1 shadow">
<table class="table">
  <thead>
    <tr>
      <th>購入日時</th>
