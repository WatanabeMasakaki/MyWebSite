...
<nav class="navbar navbar-dark bg-dark">
  <form class="form-inline mt-2 mt-md-0">
    <h3 class="text-light bg-dark"><strong>ユーザー新規登録画面　</strong></h3>
  </form>
  <form class="form-inline mt-2 mt-md-0">
...
<form method="post" action="UserCreate" id="example">
...
<div class="float-right">
  <div class="col">
    ...
    <input type="text" class="form-control" name="loginid" placeholder="ログインIDを入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>パスワード</strong></label>
    <input type="text" class="form-control" name="password" placeholder="パスワードを入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>パスワード(確認)</strong></label>
    <input type="text" class="form-control" name="passwordck" placeholder="パスワードを入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>ユーザー名</strong></label>
    <input type="text" class="form-control" name="username" placeholder="ユーザー名を入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>生年月日</strong></label>
    <input type="date" class="form-control" name="birthdate" placeholder="年/月/日"/>
  </div>
