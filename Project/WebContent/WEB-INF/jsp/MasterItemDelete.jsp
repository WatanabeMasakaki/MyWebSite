...
<title>マスタ商品情報削除</title>
</head>
<body>

<nav class="navbar navbar-dark bg-dark">
  <form class="form-inline mt-2 mt-md-0">
    <h3 class="text-light bg-dark"><strong>マスタ商品情報削除　</strong></h3>
  </form>
  <form class="form-inline mt-2 mt-md-0">
...
<div class="card bg-light mb-3 shadow" style="max-width: 50rem; margin-top: 170px; margin-bottom: 40px; margin-right: auto; margin-left: auto; text-align: left;">
 <div class="float-right">
  <div class="col">
    <p><h3>商品ID:${item.name}を本当に削除してよろしいでしょうか？</h3></p>
  </div>

<div class="container">
  <div class="row">

  <form method="get" action="ItemMaster5">
   <div class="col-sm">
  ...
  <form method="post" action="MasterItemDelete">
   <div class="col-sm">
    <p><input type="hidden" class="btn btn-secondary btn-lg" name="id2" value="${item.id}"></p>
