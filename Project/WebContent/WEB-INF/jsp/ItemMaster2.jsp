...
<nav class="navbar navbar-dark bg-dark">
  <form class="form-inline mt-2 mt-md-0">
    <h3 class="text-light bg-dark"><strong>商品マスタ新規登録　</strong></h3>
  </form>
  <form class="form-inline mt-2 mt-md-0">
...
<form method="post" action="ItemMaster2" enctype="multipart/form-data">
...
<div class="float-right">
  <div class="col">
    <label for="exampleInputEmail1"><strong>商品名</strong></label>
    <input type="text" class="form-control" name="itemname" placeholder="商品名を入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>商品詳細</strong></label>
    <input type="text" class="form-control" name="itemdetail" placeholder="商品詳細を入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>商品価格</strong></label>
    <input type="text" class="form-control" name="itemprice" placeholder="商品価格を入力">
  </div>
  <div class="col">
    <label for="exampleInputEmail1"><strong>画像ファイル</strong></label>
    <input type="file" class="form-control" name="gazoufile" placeholder="画像ファイルを入力">
  </div>
