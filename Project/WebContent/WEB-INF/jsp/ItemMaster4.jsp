...
<title>商品マスタ情報更新</title>
</head>
<body>

<nav class="navbar navbar-dark bg-dark">
  <form class="form-inline mt-2 mt-md-0">
    <h3 class="text-light bg-dark"><strong>商品マスタ情報更新　</strong></h3>
  </form>
  <form class="form-inline mt-2 mt-md-0">
...
<div class="tablestyle1 backcolor1">
 <table class="table">
  ...
  <tbody>
   ...
   <form method="post" action="ItemMaster4">
	<tr>
      <td class="center"><input type="hidden" name="itemid" value="${item.id}">${item.id}</td>
	  <td class="center"><textarea name="itemname" cols="30" rows="10" placeholder="${item.name}"></textarea></td>
	  <td class="center"><textarea name="itemdetail" cols="30" rows="10" placeholder="${item.detail}"></textarea></td>
	  <td class="center"><textarea name="itemprice" cols="15" rows="1" placeholder="${item.price}"></textarea></td>
      <td class="center"><p><input type="submit" value="　　更新　　"></p></td>
	</tr>
	</form>
   </c:forEach>
  </tbody>
